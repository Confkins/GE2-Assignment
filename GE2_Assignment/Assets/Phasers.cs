...
public class Phasers : MonoBehaviour
{
    public GameObject phaserPrefab;
    public GameObject phaser;
    public bool fire = false;
    public float targetDistance;
    public float firingDistance = 40.0f;
    ...
    void Update()
    {
        ...
        if (Physics.SphereCast(transform.position, firingArc, transform.forward, out hit, firingDistance))
        {
            ...
            if (hit.transform.tag == "BorgCube" && fire == false)
            {
                fire = true;
            }
        }
    ...
    void firePhaser()
    {
        ...
        phaser.transform.localScale = new Vector3(0.1f,targetDistance,0.1f);
